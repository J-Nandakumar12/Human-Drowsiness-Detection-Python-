...
def sound_alarm(path):
    # play an alarm sound
    playsound.playsound(r'C:\Users\91822\Pictures\MediaPipe\warning.mp3')


#def message():
    # Through Twilio send a message and make a call
    account_sid = "ACe9cedc8ceb103d0ce2194d07c86b82b0"  # Put your Twilio account SID here
    auth_token = "4533b4b90bc1c0e4295dd9b5b2c116b9"  # Put your auth token here
    ...
    message = client.api.account.messages.create(
        ...
        from_="+18126096412",  # Put your Twilio number here
        ...
        if results.multi_face_landmarks:
            ...
            if ratio > 5:
                ...
                if CEF_COUNTER > CLOSED_EYES_FRAME:
                    ...
                    sound_alarm(r'C:\Users\91822\Pictures\MediaPipe\warning.mp3')
                   # message()
